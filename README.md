# Team 18650 SDK - DECODE Season (2025-2026)

This is **Team 18650's fork** of the official [FtcRobotController](https://github.com/FIRST-Tech-Challenge/FtcRobotController) SDK for the DECODE competition season.

## For Team Members

### Where to Put Your Code
All team robot code goes in the `TeamCode` module:
```
...
- [FTC Javadoc Documentation](https://javadoc.io/doc/org.firstinspires.ftc) - API reference
